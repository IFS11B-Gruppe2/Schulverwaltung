...
class Model_Subcomponents {
	static function getAllSubcomponents($db, $orderBy = 'k.PK_ID') {
		...
		$subcomponent = array();
		$sql = '
			SELECT kart.Bezeichnung as Komponentenart, k.Seriennummer, k.Beschreibung, k.Hersteller, k.Einkaufsdatum, k.Einkaufsdatum + INTERVAL k.Gewaehrleistungsdauer YEAR as Ablaufdatum, k.Gewaehrleistungsdauer, k.Notiz, k.FK_Lieferant, k.FK_Raum, l.Name
